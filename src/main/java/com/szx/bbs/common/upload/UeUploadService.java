...
package com.szx.bbs.common.upload;

import com.szx.bbs.common.kit.ImageKit;
 ...
 *    用于创建子目录
 */
public class UeUploadService {

	public static final UeUploadService me = new UeUploadService();

	/**
	 * 上传图片允许的最大尺寸，目前只允许 500KB
	 */
	public static final int imageMaxSize = 500 * 1024;
